...
for i in range(3):
    ...
    class CustomLayer(tf.keras.layers.Layer):
        def __init__(self, num_X, num_T,**kwargs):
        ...
        def call(self, inputs):
            ...
            for i in range(self.num_X):
                # xPeriodic = self.amplitudesX[i] * tf.math.cos(xPure + self.phasesX[i]) + self.interceptsX[i]
    ...
    test_name = f'ExpHardKBBC_{nn}_{nl}_{act}_{1000}_{9261}_{2402}_{num}'
